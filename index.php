...
function initialize() {
  ...
  var posisi2 = new google.maps.LatLng(-6.242388,106.867409);
...
<section id="top_content" class="top_cont_outer">
  ...
  <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 300px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 800px; height: 300px; overflow: hidden;">
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="img/img/dora.png" />
            </div>
        </div>
        <!-- Bullet Navigator -->
    ...
    <div class="team-leader-block clearfix">
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-03s">
          ...
          <ul>
            <li><a href="javascript:void(0)" target="_blank" class="fa-twitter"></a></li>
            <li><a href="javascript:void(0)" target="_blank" class="fa-facebook"></a></li>
            <li><a href="javascript:void(0)" target="_blank" class="fa-pinterest"></a></li>
			<li><a href="https://www.instagram.com/eyfrellikuajang/" target="_blank" class="fa-instagram"></a></li>
			<li><a href="https://www.linkedin.com/in/eyfrel-likuajang-692407109?" target="_blank" class="fa-linkedin"></a></li>
          </ul>
        </div>
      ...
      <div class="team-leader-box">
        <div class="team-leader  wow fadeInDown delay-06s">
          ...
          <ul>
            <li><a href="https://www.facebook.com/g2ngLvjenz" target="_blank" class="fa-facebook"></a></li>
            <li><a href="https://www.pinterest.com/gerrypowa/" target="_blank" class="fa-pinterest"></a></li>
            <li><a href="https://www.instagram.com/gerrypowa/"  target="_blank" class="fa-instagram"></a></li>
			<li><a href="https://plus.google.com/+GerryPowa/" target="_blank" class="fa-google-plus"></a></li>
            <li><a href="https://id.linkedin.com/in/gerry-powa-9833936a" target="_blank" class="fa-linkedin"></a></li>
          </ul>
        </div>
      ...
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-09s">
          ...
          <ul>
            ...
            <li><a href="javascript:void(0)" target="_blank" class="fa-facebook"></a></li>
            <li><a href="javascript:void(0)" target="_blank" class="fa-pinterest"></a></li>
            <li><a href="javascript:void(0)" target="_blank" class="fa-google-plus"></a></li>
			<li><a href="https://www.instagram.com/p_odds/" target="_blank" class="fa-instagram"></a></li>
          </ul>
        </div>
        <h3 class="wow fadeInDown delay-09s">Revoldy Kaumpungan</h3>
        <span class="wow fadeInDown delay-09s">Operation Manager</span>
        <p class="wow fadeInDown delay-09s">"Hope is the anchor of the soul."</p>
      </div>
    </div>
  </div>
</section>
...
<section id="about"><!--main-section-start-->
...
s1.async=true;
s1.src='https://embed.tawk.to/56985da3aeafd72017dcc754/default';
s1.charset='UTF-8';
